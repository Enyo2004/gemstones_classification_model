...
# save the model 
featureExtractionAugModel.save('Models/models/model4/featureExtractionAugModel.keras')

# save the weights learned by the model
featureExtractionAugModel.save_weights('Models/models/model4/featureExtractionAugModel.weights.h5')
